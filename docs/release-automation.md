...
enabling preview technology. Its managed solution depends on the 11 core Dataverse tables used by
the transcript, flow, inventory, credit, capacity, privacy, and sync experiences.
